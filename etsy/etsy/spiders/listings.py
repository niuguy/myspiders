...
class ListingsSpider(scrapy.Spider):
    ...
    def __init__(self, kw='', pn=10 , **kwargs):
        ...
        file_name = 'results/listings/{0}_top{1}pages_listings_{2}.json'.format(self.key_word.replace(" ","-"), self.page_num, datetime.datetime.now().strftime("%y%m%d"))
    ...
    def parse_detail(self, response):
        ...
        listing = Listing()
        listing['title'] = response.xpath('//h1[@data-buy-box-listing-title]/text()').get()
